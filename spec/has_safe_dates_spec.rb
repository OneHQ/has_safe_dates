...
describe "HasSafeDates" do
  ...
  describe "multiparameter parsing" do
    ...
    it "doesn't blow up when given an incorrect values" do
      invalid_post_attributes = {'published_date(1i)' => "abc", 'published_date(2i)' => "12", 'published_date(3i)' => "1"}
      invalid_comment_attributes = {'approved_at(1i)' => "abc", 'approved_at(2i)' => "12", 'approved_at(3i)' => "1"}
      expect {
    ...
    it "does not interfere with a date column that it has not been told to make safe" do
      invalid_attributes = {'unsafe_date(1i)' => "abc", 'unsafe_date(2i)' => "12", 'unsafe_date(3i)' => "1"}
      expect {
